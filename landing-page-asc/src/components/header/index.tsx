      ...
      <div className="relative isolate px-6 pt-14 lg:px-8">
        ...
        >
          <div
            ...
            className="relative left-[calc(50%-11rem)] aspect-1155/678 w-[36.125rem] -translate-x-1/2 rotate-[30deg] bg-linear-to-tr from-[#366352] to-[#053781] opacity-90 sm:left-[calc(50%-30rem)] sm:w-[72.1875rem]"
          />
        </div>
        <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
          <div className="hidden sm:mb-8 sm:flex sm:justify-center">
            <div className="relative rounded-full px-3 py-1 text-sm/6 text-gray-400 ring-1 ring-gray-100/50 hover:ring-gray-100/10">
              ...
              >
                ...
                Falar conosco <span aria-hidden="true">&rarr;</span>
              </a>
            </div>
          </div>
        ...
        >
          <div
            ...
            className="relative left-[calc(50%+3rem)] aspect-1155/678 w-[36.125rem] -translate-x-1/2 bg-linear-to-tr from-[#366352] to-[#053781] opacity-70 sm:left-[calc(50%+36rem)] sm:w-[72.1875rem]"
          />
        </div>
      </div>
    </div>
